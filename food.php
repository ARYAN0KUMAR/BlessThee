...
<body>
  ...
  <div class="form">
    <h1 class="Food">Food Donation</h1>
  ...
  <div class="row">
        ...
        <div class="form-row">
          ...
          <div class="form-group col-md-4">
            ...
            <select id="inputState" class="form-control" required aria-required="true" name="how">
              ...
              <option value="Drop Yourselfr">Drop Yourself</option>
            </select>

            <div class="form-group">
              <label for="inputFood">Food Type</label>
              <input type="text" class="form-control" id="inputAddress2" placeholder="Rice, Dal, Wheat, etc" name="type" required>
            </div>
            ...
            <br>
            <select id="meal" class="selector" required aria-required="true" name="quantity">
              <option selected="" disabled="" hidden="" value="">Quantity*</option>
              <option value="50-200 Meals">>5kgs</option>
              <option value="200-500 Meals">>10kgs</option>
              <option value="500-1000 Meals">10-20kgs</option>
              <option value="1000+ Meals"> < 20kgs</option>
            </select>
    ...
    <div class="col-lg-6 col-md-12" >
      <img class="img1" src="FoodDonationBox.jpeg" alt="donation time img">
    </div>
  ...
  <div class="bottom">
    ...
    <a class="active2" href="#contact">Contact on :7263889831</a>
