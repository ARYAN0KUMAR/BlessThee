...
<body>
  <div class="topnav">
    ...
    <a class="active" href="https://chat.whatsapp.com/BRuDuJckger2J4gbaFeAEO"><i class="fa fa-whatsapp" style="font-size:48px;color:green"></i></a>
    <a class="active" href="index4.html">About</a>
    <a class="active" href="index4.html">Home</a>
  </div>

  <div class="form">
    <h1 class="Food">Clothes Donation</h1>
  </div>

  <div class="row">
    <div class=" col-lg-6 col-md-12">
      <form action="connclothes.php" method="post">
        <div class="form-row">
          <div class="col">
          ...
          <div class="form-group col-md-4">
            ...
            <div class="termsbox">
              <div class="form-group" style="font-size: 11px !important; margin-bottom: 30px; width: 90%; display: inline-flex;">
                ...
                <p class="checkbox-text">By checking this box, I confirm the quality of clothes to be in normal condition.</p>
              </div>
            </div>
    ...
    <div class="col-lg-6 col-md-12" >
      <img class="img1" src="clothesdonation.jpg" alt="donation time img">
    </div>
